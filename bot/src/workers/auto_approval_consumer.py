...
async def _update_job_status(
    ...
    # DB columns generated by Prisma are timestamp (naive) for this table.
    # asyncpg raises DataError if binding tz-aware datetime into timestamp.
    now = datetime.utcnow()
...
async def _send_reply(
    ...
    default_exchange = await channel.get_exchange("")
    await default_exchange.publish(message, routing_key=reply_to)
