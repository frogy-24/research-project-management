...
export const disbursementsApi = {
  ...
  async getDisbursements(
    ...
    const { data } = await axiosInstance.get('/api/disbursements', {
      params: filters,
    });
    return data;
  },
  ...
  async getDisbursementById(id: string): Promise<ApiResponse<FundingDisbursementWithRelations>> {
    const { data } = await axiosInstance.get(`/api/disbursements/${id}`);
    return data;
  },
  ...
  async getDisbursementsByProject(projectId: string): Promise<ApiResponse<FundingDisbursementWithRelations[]>> {
    const { data } = await axiosInstance.get(`/api/projects/${projectId}/disbursements`);
    return data;
  },
  ...
  async createDisbursement(input: CreateDisbursementInput): Promise<ApiResponse<FundingDisbursement>> {
    const { data } = await axiosInstance.post('/api/disbursements', input);
    return data;
  },
  ...
  async updateDisbursement(
    ...
    const { data } = await axiosInstance.patch(`/api/disbursements/${id}`, input);
    return data;
  },
  ...
  async approveDisbursement(
    ...
    const { data } = await axiosInstance.post(`/api/disbursements/${id}/approve`, input);
    return data;
  },
  ...
  async rejectDisbursement(
    ...
    const { data } = await axiosInstance.post(`/api/disbursements/${id}/reject`, input);
    return data;
  },
  ...
  async deleteDisbursement(id: string): Promise<ApiResponse<void>> {
    const { data } = await axiosInstance.delete(`/api/disbursements/${id}`);
    return data;
  },
  ...
  async getDisbursementStats(filters?: {
    ...
    const { data } = await axiosInstance.get('/api/disbursements/stats', {
      params: filters,
    });
    return data;
  },
  ...
  async getPendingDisbursements(params?: {
    ...
    const { data } = await axiosInstance.get('/api/disbursements/pending', {
      params,
    });
    return data;
  },
  ...
  async canCreateDisbursement(projectId: string): Promise<ApiResponse<{
    ...
    const { data } = await axiosInstance.get(`/api/projects/${projectId}/can-create-disbursement`);
    return data;
  },
};
